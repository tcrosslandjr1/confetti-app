...
| Category | Energy | Best For |
|----------|--------|----------|
| 🔥 Trending Areas | Hot neighborhoods right now | Warm-up, setting the scene |
| 🎭 Things To Do | Events, shows, activities | Main Event, Warm-up |
| ⭐ Popular Places | Crowd-favorite restaurants, bars, cafes | Main Event, Warm-up |
| 💎 Unique Experiences | Speakeasies, immersive, pop-ups | Twist Moments |
| 📱 Instagrammy | Aesthetic cafes, murals, photo spots | Any stop for content-focused groups |
| 🎲 Themes | Occasion-based (bachelor, girls night, date night) | Full boarding pass theming |
| 🏘️ Locals Love | Hidden gems, neighborhood favorites | Twist Moments, Finales |
| 🍽️ Food & Drink | Cuisine-specific dining (seafood, sushi, BBQ) | Main Event |
| 🌙 Nightlife | Clubs, lounges, cocktail bars, live music | Finales, Twists |
| 🧘 Wellness | Spas, yoga, self-care | Wellness-themed passes |
| 🛍️ Shopping | Boutiques, thrift, vintage | Daytime boarding passes |
| 🏔️ Adventure | Hikes, water sports, go-karts, arcades | Active/outdoor passes |
| 🏛️ Culture | Museums, galleries, historical tours | Culture-themed passes |
| 👨‍👩‍👧‍👦 Family | Kid-friendly activities, zoos, bowling | Family-safe itineraries |
| 🌊 Waterfront | Waterfront dining, boat cruises, beaches | Scenic stops, Finales |

**How to use:** After decoding the user's vibe (Layer 1), match their mood to the relevant categories using the Tag-to-Vibe Translation table in the Idea Engine. Then mix categories across stops using the Cross-Category Mixing Rules to create variety within a single boarding pass.

**Refresh awareness:** Categories marked `daily` (Things To Do) should surface time-sensitive events. Categories marked `weekly` (Trending Areas, Popular Places, Instagrammy, Nightlife, Food & Drink, Waterfront) rotate frequently. Categories marked `monthly` (Unique Experiences, Locals Love, Wellness, Shopping, Adventure, Culture, Family) are more stable.
...
### Layer 1: Vibe Layer
Decode what the user actually wants from their mood, occasion, and energy level. Map keywords and emoji to concrete experience types. "Chill vibes" means something different for a couple vs. a group of 8. **Use the Tag-to-Vibe Translation table** from the Idea Engine to map user language to query categories.

### Layer 2: City Intelligence Layer
Activate local knowledge for the target city. Consider neighborhoods, transit patterns, walking distances, seasonal factors, time-of-day energy shifts, and which areas pair well together for a multi-stop night. **Run the matched query templates** with `{city}` replaced by the target city to source fresh venue candidates.
