...
// ═════════════════════════════════════════════════════════════════
function NightTogetherScreen({ onBack, onPrint, crew }) {
  const [phase, setPhase] = useStateCr('setup'); // setup | voting | ready
  const [invited, setInvited] = useStateCr(crew?.members || ['maya', 'devon']);
  ...
  return (
    <div className="cf-screen" style={{
      ...
      <div style={{
        ...
        <Stamp color="var(--accent-1)" rotate={-2}>{crew?.name || 'night together'}</Stamp>
        <span style={{ width: 36 }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 2, flex: 1,
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            ...
            <button onClick={() => navigator.clipboard?.writeText(`https://confetti.app/p/${Date.now().toString(36)}`)}
                    style={{
              ...
              background: 'var(--ink)', color: 'var(--paper)',
              fontFamily: 'var(--cf-ui)', fontSize: 12, fontWeight: 800,
              boxShadow: '2px 2px 0 var(--accent-1)',
          ...
          <div style={{
            ...
            fontFamily: 'var(--cf-mono)', fontSize: 10, fontWeight: 700,
            letterSpacing: '.04em', lineHeight: 1.4, opacity: 0.85,
          }}>
            🔗 https://confetti.app/p/n8t-{Math.random().toString(36).slice(2, 6)}
            <br/>
