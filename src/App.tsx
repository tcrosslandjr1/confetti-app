...
import { PortalRoute } from "./components/BusinessPortal";
        ...
        <div className="phone-shell">
          ...
          <AnimatePresence initial={false} mode="sync">
            ...
            <Routes location={location}>
              ...
              <RouterRoute path="/admin" element={<AdminRoute><AdminCenter /></AdminRoute>} />
              ...
              <RouterRoute path="/admin/fund" element={<AdminRoute require="manager"><FundAdminDashboard /></AdminRoute>} />
              <RouterRoute path="/admin/trending" element={<AdminRoute><TrendingTracker /></AdminRoute>} />
              <RouterRoute path="/admin/agents" element={<AdminRoute><AgentControlCenter /></AdminRoute>} />
              <RouterRoute path="/venue/scan" element={<BarcodeScanView />} />
              <RouterRoute path="/business/:id" element={<BusinessRoute />} />
              <RouterRoute path="/portal/:id" element={<PortalRoute />} />
