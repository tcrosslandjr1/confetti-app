    ...
    <>
      {bannerVisible && (
        <div
          ...
          className="fixed inset-x-3 bottom-[calc(env(safe-area-inset-bottom)+5rem)] z-[80] mx-auto max-w-2xl rounded-xl border-2 border-ink bg-cream p-4 text-ink shadow-lg sm:p-5 lg:bottom-4"
        >
