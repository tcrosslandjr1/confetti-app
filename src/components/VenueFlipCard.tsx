...
export function VenueFlipCard({
  ...
  const accentBorder = accent === "purple" ? "border-purple/20" : "border-ink";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "absolute inset-0 overflow-hidden rounded-2xl border-2 bg-white shadow-brut [backface-visibility:hidden]",
            accentBorder,
          )}
        >
          {venue.photo ? (
        ...
        <div
          className={cn(
            "absolute inset-0 overflow-hidden rounded-2xl border-2 bg-white shadow-brut [backface-visibility:hidden] [transform:rotateY(180deg)]",
            accentBorder,
          )}
        >
