...
export const CITIES: CityContext[] = [
  make({
    ...
    allowedActivities: [
      "rooftop bars", "wine bars", "small plates", "vinyl bars",
      "live jazz", "speakeasies", "waterfront dining", "comedy clubs",
    ],
    neighborhoods: [
    ...
    priceNorms: { $: "casual bars, pubs", $$: "cocktail bars, mid-range", $$$: "rooftops, fine dining" },
  ...
  make({
    ...
    allowedActivities: [
      "casinos", "shows", "rooftop lounges", "late-night dining",
      "pool clubs", "speakeasies", "Topgolf", "fountain shows",
    ],
    ...
    signatureExperiences: ["Bellagio fountains", "blackjack flight", "Topgolf nightcap", "rooftop pool"],
    priceNorms: { $: "casual eats, locals bars", $$: "casino bars, mid-range", $$$: "Strip clubs, fine dining" },
  ...
  make({
    ...
    allowedActivities: [
      "beach clubs", "waterfront dinners", "boat rides", "Latin music spots",
      "rooftop lounges", "late-night cafés", "salsa dancing",
    ],
    environmentFeatures: ["beach", "waterfront", "skyline", "art deco"],
    signatureExperiences: ["sunset on Brickell Key", "salsa at Ball & Chain", "beachfront cocktail", "rooftop sushi"],
    priceNorms: { $: "Cuban diners, taquerías", $$: "Wynwood bars, mid-range", $$$: "Brickell skyline, beach clubs" },
    transport: { maxTravelMinutes: 12, avoidCrossCity: true },
  }),
  make({
    city: "New York",
    ...
    allowedActivities: [
      "rooftop bars", "speakeasies", "broadway shows", "comedy clubs",
      "late-night dining", "jazz clubs", "wine bars",
    ],
    environmentFeatures: ["skyline", "rooftops", "subway-walkable", "bridges"],
    signatureExperiences: ["WTC rooftop view", "speakeasy hop in LES", "late slice + dive bar", "jazz in Harlem"],
    priceNorms: { $: "slice shops, dive bars", $$: "cocktail bars, small plates", $$$: "rooftops, tasting menus" },
    transport: { maxTravelMinutes: 12, avoidCrossCity: true },
  }),
  make({
    city: "Seattle",
    ...
    allowedActivities: [
      "harbor cruises", "piers", "cozy cocktail bars", "live indie music",
      "wine bars", "small plates", "seafood dining",
    ],
    environmentFeatures: ["harbor", "piers", "ferries", "mountain views"],
    signatureExperiences: ["sunset Pier 62 walk", "Pike Place evening", "harbor cruise", "Capitol Hill bar crawl"],
    priceNorms: { $: "breweries, casual bars", $$: "cocktail bars, seafood", $$$: "rooftops, upscale dining" },
    transport: { maxTravelMinutes: 12, avoidCrossCity: true },
  }),
  make({
    city: "Chicago",
    ...
    allowedActivities: [
      "rooftop bars", "speakeasies", "blues clubs", "comedy clubs",
      "lakefront walks", "deep-dish dining",
    ],
    environmentFeatures: ["lakefront", "river", "skyline", "L-train walkable"],
    signatureExperiences: ["river architecture cruise", "Second City show", "blues at Kingston Mines", "rooftop skyline view"],
    priceNorms: { $: "neighborhood bars, deep-dish", $$: "cocktail bars, mid-range", $$$: "River North rooftops, tasting menus" },
    transport: { maxTravelMinutes: 12, avoidCrossCity: true },
  }),
  // ── New launch cities ────────────────────────────────────────────────
  make({
    ...
    allowedActivities: [
      "rooftop lounges", "beach bars", "speakeasies", "live music",
      "late-night tacos", "comedy clubs", "sunset viewpoints",
    ],
    environmentFeatures: ["beach", "rooftops", "hills", "palm-lined streets"],
    signatureExperiences: ["Santa Monica pier sunset", "DTLA rooftop hop", "comedy at the Comedy Store", "late-night taco truck"],
    priceNorms: { $: "taco trucks, dive bars", $$: "cocktail bars, mid-range", $$$: "rooftops, celebrity spots" },
  ...
  make({
    ...
    allowedActivities: [
      "wine bars", "speakeasies", "tasting menus", "rooftop lounges",
      "waterfront dining", "jazz clubs", "small plates",
    ],
    avoid: ["beach clubs", "casinos"],
    environmentFeatures: ["bay", "bridges", "hills", "waterfront"],
    signatureExperiences: ["Embarcadero sunset stroll", "speakeasy in Tenderloin", "Ferry Building bites", "North Beach jazz"],
    priceNorms: { $: "Mission tacos, dive bars", $$: "wine bars, cocktail bars", $$$: "tasting menus, rooftops" },
    transport: { maxTravelMinutes: 12, avoidCrossCity: true },
  }),
  make({
    city: "Houston",
    ...
    allowedActivities: [
      "rooftop bars", "ice houses", "Tex-Mex dining", "BBQ joints",
      "live music", "speakeasies", "cocktail bars",
    ],
    avoid: ["beach bars", "harbor cruises"],
    environmentFeatures: ["skyline", "humid nights", "patios", "sprawl"],
    signatureExperiences: ["Montrose bar crawl", "rooftop in Midtown", "BBQ + beer in the Heights", "EaDo live music"],
    priceNorms: { $: "ice houses, taquerías", $$: "cocktail bars, BBQ", $$$: "downtown skyline, steak" },
    transport: { maxTravelMinutes: 18, avoidCrossCity: true },
  }),
  make({
    city: "Atlanta",
    ...
    allowedActivities: [
      "rooftop bars", "soul food dining", "speakeasies", "lounges",
      "live hip-hop", "comedy clubs", "BeltLine patios",
    ],
    avoid: ["beach bars", "harbor cruises"],
    environmentFeatures: ["BeltLine", "skyline", "patios", "tree canopy"],
    signatureExperiences: ["BeltLine patio crawl", "Buckhead rooftop", "Edgewood late-night", "soul food + cocktails"],
    priceNorms: { $: "BeltLine bars, soul food", $$: "cocktail bars, mid-range", $$$: "Buckhead lounges, rooftops" },
