...
export const FOOD_ANCHORS: VenueAnchor[] = [
  { id: "seafood-crab",   label: "Seafood / crab house",         category: "food", vibeTags: ["foodie", "celebratory"],       slot: "early" },
  { id: "steakhouse",     label: "Steakhouse",                   category: "food", vibeTags: ["foodie", "date", "upscale"],   slot: "early" },
  { id: "kbbq-hotpot",    label: "KBBQ / hot pot",               category: "food", vibeTags: ["foodie", "group", "shared"],   slot: "early" },
  { id: "tacos-tapas",    label: "Tacos / tapas",                category: "food", vibeTags: ["foodie", "budget", "shared"],  slot: "early" },
...
export const SOCIAL_ANCHORS: VenueAnchor[] = [
  { id: "lounge",         label: "Lounge",          category: "social", vibeTags: ["chill", "date", "turn-up"],   slot: "mid" },
  { id: "hookah-lounge",  label: "Hookah lounge",   category: "social", vibeTags: ["chill", "turn-up"],           slot: "mid" },
  { id: "rooftop",        label: "Rooftop",         category: "social", vibeTags: ["date", "chill", "scenic"],    slot: "mid" },
  { id: "karaoke",        label: "Karaoke",         category: "social", vibeTags: ["turn-up", "group", "playful"],slot: "mid" },
...
export const ACTIVITY_ANCHORS: VenueAnchor[] = [
  { id: "casino-night",   label: "Casino night",    category: "activity", vibeTags: ["competitive", "turn-up"],   slot: "mid" },
  { id: "bowling",        label: "Bowling",         category: "activity", vibeTags: ["competitive", "group"],     slot: "mid" },
  { id: "pool-hall",      label: "Pool hall",       category: "activity", vibeTags: ["competitive", "chill"],     slot: "mid" },
  { id: "arcade-bar",     label: "Arcade bar",      category: "activity", vibeTags: ["competitive", "playful"],   slot: "mid" },
