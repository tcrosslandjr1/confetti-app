...
export const DISH_DB: Record<string, DishInfo> = {
  "Truffle rigatoni": {
    ...
    kind: "food", vegetarian: true, pescatarian: true,
  },
  "Spicy tuna crispy rice": {
    ...
    spice: 2,
    kind: "food", pescatarian: true, glutenFree: true,
  },
  ...
  "Burrata + peaches": {
    ...
    kind: "food", vegetarian: true, pescatarian: true, glutenFree: true,
  },
  "Short rib tacos": {
  ...
  "Yuzu old fashioned": {
    ...
    kind: "drink", vegetarian: true, vegan: true, pescatarian: true, glutenFree: true,
  },
  "Espresso martini": {
    ...
    kind: "drink", vegetarian: true, pescatarian: true, glutenFree: true,
  },
  "Smoked negroni": {
