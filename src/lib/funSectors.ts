...
export const funSectors: FunSector[] = [
  ...
  },
  {
    ...
    shortLabel: "Watch",
    description:
      "Concerts, comedy, theater, open mics, jazz, drag, stage shows, and ticketed live events.",
  ...
  },
  {
    ...
    shortLabel: "Move",
    description:
      "Golf, mini golf, simulators, driving ranges, bowling, skating, pickleball, arcades, and active hangouts.",
    examples: [
      "golf",
      "mini golf",
      "driving ranges",
  ...
  },
  {
    ...
    shortLabel: "Date",
    description:
      "Intimate restaurants, wine bars, sunset spots, cozy activities, and mood-led plans.",
  ...
  },
  {
    ...
    shortLabel: "Group",
    description:
      "Game nights, karaoke, trivia, board game cafes, barcades, paint-and-sip, group dinners, and team activities.",
  ...
  },
  {
    ...
    description:
      "TikTok foods, dessert spots, food trucks, lines, hype dishes, and creator-mentioned bites.",
  ...
  },
  {
    ...
    shortLabel: "Luxury",
    description:
      "Fine dining, private rooms, bottle service, chauffeurs, premium views, and celebrations.",
  ...
  },
  {
    ...
    shortLabel: "Events",
    description:
      "Events, holiday markets, parades, street fairs, festivals, pop-ups, limited-run moments, and weekend happenings.",
    examples: [
      "events",
      "holiday markets",
      "street fairs",
  ...
  },
  {
    ...
    shortLabel: "Tour",
    description:
      "Landmarks, neighborhood crawls, tours, day trips, scenic routes, and local discovery.",
  ...
  },
  {
    ...
    description:
      "Mature nightlife, cigar bars, burlesque, supper clubs, late lounges, and adults-only venues.",
