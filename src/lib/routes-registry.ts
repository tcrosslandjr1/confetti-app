...
export const ROUTE_REGISTRY: RouteEntry[] = [
  ...
  { path: "/about", purpose: "acquisition", oneJob: "Tell the brand story to build trust." },
  {
    path: "/how-it-works",
    purpose: "acquisition",
    oneJob: "Explain the 3-step plan flow.",
    flags: ["merge-candidate"],
    notes: "Could merge with /features.",
  },
  {
    path: "/features",
    purpose: "acquisition",
    oneJob: "List product capabilities for evaluators.",
    flags: ["merge-candidate"],
    notes: "Overlaps /how-it-works.",
  },
  {
    path: "/pricing",
    purpose: "acquisition",
    oneJob: "Communicate price and remove cost objections.",
  },
  {
    path: "/testimonials",
    purpose: "acquisition",
    oneJob: "Show social proof from real users.",
    flags: ["thin"],
  },
  ...
  { path: "/create", purpose: "money-path", oneJob: "Collect inputs in <60s to generate a plan." },
  {
    path: "/plan",
    purpose: "money-path",
    oneJob: "Run the plan-generation step.",
    flags: ["merge-candidate"],
    notes: "Consider merging with /plan/ready.",
  },
  { path: "/plan/preview", purpose: "money-path", oneJob: "Preview a sample plan for skeptics." },
  {
    path: "/plan/ready",
    purpose: "money-path",
    oneJob: "Deliver the ready plan and drive next action (share/save).",
  },
  {
    path: "/quick-generate",
    purpose: "money-path",
    oneJob: "1-click plan generation for power users.",
    flags: ["duplicate"],
    notes: "Overlaps /create.",
  },
  ...
  { path: "/passport", purpose: "retention", oneJob: "Show Confetti balance & rewards progress." },
  {
    path: "/partners",
    purpose: "retention",
    oneJob: "List partner rewards redeemable with Confetti.",
  },
  {
    path: "/boarding-pass",
    purpose: "retention",
    oneJob: "Render the wallet/boarding-pass artifact.",
  },
  ...
  { path: "/events", purpose: "discovery", oneJob: "Browse upcoming events." },
  {
    path: "/events/$eventId",
    purpose: "discovery",
    oneJob: "Sell a single event (details + CTA).",
  },
  ...
  // ── Social / Sharing ────────────────────────────────────────────────────
  {
    path: "/collab/$tripId",
    purpose: "social",
    oneJob: "Co-plan a trip with friends in real time.",
  },
  {
    path: "/rsvp/$token",
    purpose: "social",
    oneJob: "RSVP via shared token link.",
    flags: ["merge-candidate"],
    notes: "Two RSVP routes; unify token+tripId.",
  },
  {
    path: "/rsvp/$tripId",
    purpose: "social",
    oneJob: "RSVP via tripId.",
    flags: ["merge-candidate"],
  },
  ...
  {
    path: "/trips/$id/passport",
    purpose: "social",
    oneJob: "Review & rate a single completed trip (stops + overall).",
  },
  {
    path: "/recap/$itineraryId",
    purpose: "social",
    oneJob: "Shareable recap of a completed trip.",
  },
  {
    path: "/favorites",
    purpose: "retention",
    oneJob: "Saved venues/events for the member.",
    flags: ["split-portal"],
    notes: "Overlaps /portal/saved.",
  },
  ...
  {
    path: "/concierge/chat/$threadId",
    purpose: "concierge",
    oneJob: "Continue a concierge thread.",
  },
  {
    path: "/concierge/passport",
    purpose: "concierge",
    oneJob: "Redirect → /passport (consolidated).",
    flags: ["deprecated"],
    notes: "Legacy redirect; canonical lives at /passport.",
  },
  {
    path: "/concierge/profile",
    purpose: "concierge",
    oneJob: "Profile inside concierge.",
    flags: ["split-portal"],
  },
  {
    path: "/chat",
    purpose: "concierge",
    oneJob: "Generic chat entry.",
    flags: ["duplicate"],
    notes: "Overlaps /concierge/chat.",
  },
  ...
  { path: "/portal/refer", purpose: "portal", oneJob: "Generate referral links." },
  {
    path: "/portal/viral",
    purpose: "portal",
    oneJob: "Viral mechanics inside portal.",
    flags: ["duplicate"],
    notes: "Overlaps /viral.",
  },
  {
    path: "/me",
    purpose: "portal",
    oneJob: "Shortcut to current user.",
    flags: ["thin"],
    notes: "Consider redirect to /portal/profile.",
  },
  {
    path: "/active-loop",
    purpose: "portal",
    oneJob: "Show currently active loop.",
    flags: ["needs-owner"],
  },
  {
    path: "/active-confetti",
    purpose: "retention",
    oneJob: "Show in-progress Confetti earn.",
    flags: ["needs-owner"],
  },
  ...
  {
    path: "/advertise/stories/$slug",
    purpose: "business",
    oneJob: "Show a single advertiser story.",
  },
  ...
  { path: "/cookies", purpose: "legal", oneJob: "Cookie policy." },
  {
    path: "/data-terms",
    purpose: "legal",
    oneJob: "Data-processing terms.",
    flags: ["merge-candidate"],
    notes: "Could fold into /privacy.",
  },
  ...
  { path: "/admin/launch", purpose: "admin", oneJob: "Pre-launch checklist." },
  {
    ...
    purpose: "admin",
    oneJob: "Internal map of every route + consolidation flags.",
  },
