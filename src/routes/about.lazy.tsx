            ...
            {VALUES.map((v, i) => {
              ...
              return (
                <Reveal key={v.title} delay={i * 60}>
                  <div
                    className={`h-full rounded-2xl border-2 border-ink bg-cream p-6 shadow-brut transition-pop hover:-translate-x-1 hover:-translate-y-1 hover:shadow-brut-lg ${rot}`}
                  >
                    <div
                      className={`grid h-12 w-12 place-items-center rounded-xl border-2 border-ink ${v.color}`}
                    >
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {TEAM.map((t, i) => (
              <Reveal key={t.name} delay={i * 60}>
                <div
                  className={`group h-full rounded-2xl border-2 border-ink bg-cream p-6 shadow-brut transition-pop hover:-translate-x-1 hover:-translate-y-1 hover:shadow-brut-lg ${t.rot} hover:rotate-0`}
                >
                  <div
                    className={`grid h-20 w-20 place-items-center rounded-2xl border-2 border-ink ${t.color} font-display text-2xl font-extrabold`}
                  >
                    {t.initials}
                  </div>
      ...
      <section className="relative overflow-hidden border-b-2 border-ink bg-ink text-cream">
        ...
        <div className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
          ...
          <a
            ...
            className="mt-8 inline-flex h-14 items-center gap-2 rounded-full border-2 border-cream bg-coral px-7 text-base font-bold text-cream shadow-brut transition-pop hover:-translate-x-1 hover:-translate-y-1 hover:shadow-brut-lg"
          >
