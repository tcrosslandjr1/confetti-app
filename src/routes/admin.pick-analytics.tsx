...
const METRICS: { key: Metric; label: string; icon: typeof Eye; color: string }[] = [
        ...
        {METRICS.map((m) => {
          ...
          return (
            <button
              ...
              className={`group relative overflow-hidden rounded-2xl border p-5 text-left shadow-card transition ${
                active
