...
const tabTriggerClass =
  "rounded-lg font-mono text-[9px] font-bold uppercase tracking-widest focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/30 focus-visible:ring-offset-1 data-[state=active]:bg-ink data-[state=active]:text-cream data-[state=active]:shadow-brut";
  ...
  return (
    <div className="pb-24">
      ...
      <section className="px-5">
        <div className="relative overflow-hidden rounded-2xl border-2 border-ink bg-white p-5 shadow-brut">
          ...
          <div className="relative flex items-center gap-4">
            <div className="relative shrink-0">
              ...
              <div className="absolute -bottom-1.5 -right-1.5 grid size-7 place-items-center rounded-lg bg-ink font-mono text-[10px] font-bold text-cream shadow-md ring-2 ring-ink/20">
                {level}
              </div>
            </div>
            <div className="min-w-0 flex-1">
              <div className="truncate font-display text-xl font-extrabold tracking-tight text-ink">
              ...
              <div className="mt-2.5 flex items-center gap-2">
                ...
                <span className="shrink-0 font-mono text-[10px] font-bold text-ink/50">
                  {xp} XP
                </span>
              </div>
      ...
      <section className="mt-6 px-5">
        <Tabs value={activeTab} onValueChange={(v) => { setActiveTab(v); trackEngagement("profile_tab", { tab: v }); }} className="w-full">
          <TabsList className="grid w-full grid-cols-6 gap-1 rounded-xl bg-ink/5 p-1">
...
function OverviewTab({
  ...
  return (
    <div className="space-y-4 pt-2">
      {/* Quick Actions */}
      <Card className="border-2 border-ink divide-y divide-ink/15">
        <QuickRow
          icon={Sparkles}
        ...
        <div>
          ...
          <div className="space-y-2">
            {recentTrips.map((trip) => (
              ...
              >
                <Card className="border-2 border-ink flex items-center gap-3 p-3 transition-all duration-200 hover:shadow-card-hover active:scale-[0.98]">
...
function BookingsTab({ userId }: { userId: string }) {
  ...
  return (
    <div className="space-y-2 pt-2">
      {bookings.map((b) => (
        <Card key={b.id} className="border-2 border-ink flex items-center gap-3.5 p-3.5">
          <div className="grid size-9 shrink-0 place-items-center rounded-xl bg-coral/10">
          ...
          <div className="space-y-2">
            {savedPlans.map((p) => (
              <Link key={p.id} to="/trips/$id" params={{ id: p.id }}>
                <Card className="border-2 border-ink flex items-center gap-3.5 p-3.5 transition-all duration-200 hover:shadow-card-hover active:scale-[0.98]">
                  <div className="grid size-9 shrink-0 place-items-center rounded-xl bg-coral/10">
                    <MapPin className="size-4 text-coral" />
                  </div>
                  <div className="min-w-0 flex-1">
...
function PassportTab({
  ...
  return (
    <div className="space-y-4 pt-2">
      {/* XP Progress */}
      <Card className="border-2 border-ink p-4">
      ...
      <div>
        ...
        {achievements && achievements.length > 0 ? (
          <div className="space-y-2">
            {achievements.map((a) => (
              <Card key={a.id} className="border-2 border-ink flex items-center gap-3.5 p-3.5">
          ...
          <Card className="border-2 border-ink p-5 text-center">
    ...
    <div className="space-y-4 pt-2">
      ...
      <Card className="border-2 border-ink p-4">
        ...
        {refCode && (
          <div className="mt-3.5 flex items-center gap-2">
            <div className="flex-1 truncate rounded-xl border-2 border-ink/15 bg-ink/5 px-3 py-2.5 font-mono text-[11px] text-ink/70">
              {refCode}
            </div>
      ...
      {stats && (
        <div className="grid grid-cols-2 gap-3">
          <Card className="border-2 border-ink p-3.5 text-center">
...
function SettingsTab({
  ...
  return (
    <div className="space-y-4 pt-2">
      {/* Display Name */}
      <Card className="border-2 border-ink space-y-3.5 p-4">
      ...
      <Card className="border-2 border-ink divide-y divide-ink/15">
        <Link
          to="/privacy"
          className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-ink/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/40 focus-visible:ring-offset-1 rounded-xl"
        >
...
function ConnectedAccountsCard() {
  ...
  return (
    <Card className="border-2 border-ink space-y-3 p-4">
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {identities.map((i) => (
            <div key={i.id} className="flex items-center justify-between rounded-xl border-2 border-ink/15 bg-ink/5 px-3.5 py-2.5">
...
function StatCard({
  ...
  return (
    <Card className="border-2 border-ink group relative overflow-hidden p-3 text-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-card-hover">
      {Icon && (
...
function QuickRow({
  ...
  return (
    <button
      onClick={onClick}
      className="group flex w-full items-center gap-3.5 px-4 py-3.5 text-left transition-colors hover:bg-ink/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/40 focus-visible:ring-offset-1 rounded-xl"
    >
  ...
  return (
    <div className="space-y-3 pt-4">
      {[1, 2, 3].map((i) => (
        <div
          key={i}
          className="h-16 rounded-xl bg-ink/5 relative isolate overflow-hidden before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r before:from-transparent before:via-ink/5 before:to-transparent before:animate-[skeleton-shimmer_1.8s_ease-in-out_infinite] before:bg-[length:200%_100%]"
        />
      ))}
    </div>
  );
