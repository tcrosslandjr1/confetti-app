...
const features = [
  {
    ...
    body: "Pick a vibe — date night, kids day out, guys' night — and get a full schedule in seconds.",
    color: "bg-coral",
    tag: "01 / vibe-in",
  },
  {
  ...
  {
    icon: Calendar,
    title: "Saved reservations",
    body: "Store confirmations, party size, contact info and times for every stop in one place.",
    color: "bg-gold",
    tag: "03 / locked-in",
  },
  {
    icon: Heart,
    title: "Taste profile",
    body: "Tell us what you love. We learn from your social vibe and tune every suggestion to match.",
    color: "bg-mint",
    tag: "04 / you-shaped",
  },
  {
    ...
    body: "Jump parks, paint nights, Home Depot kids days, hidden patios — not the same five chain restaurants.",
    color: "bg-coral",
    tag: "05 / off-menu",
  },
  {
    ...
    body: "Couples, families, elders, friend groups. Different ages, different energies, perfect plans.",
    color: "bg-purple",
    tag: "06 / crew-aware",
  },
];
      ...
      <section className="relative overflow-hidden border-b-2 border-ink">
        ...
        <div className="mx-auto max-w-7xl px-4 pb-20 pt-16 sm:px-6 lg:px-8 lg:pb-28 lg:pt-20">
          <span className="inline-flex items-center gap-2 rounded-full border-2 border-ink bg-cream/90 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] backdrop-blur">
            <Sparkles className="h-3.5 w-3.5 text-coral" />/ features
          </span>
            ...
            {features.map((f, i) => {
              ...
              return (
                <Reveal key={f.title} delay={i * 60}>
                  <div
                    className={`group relative h-full rounded-2xl border-2 border-ink bg-cream p-6 shadow-brut transition-pop hover:-translate-x-1 hover:-translate-y-1 hover:shadow-brut-lg ${rot}`}
                  >
                    <div className="flex items-start justify-between">
                      <div
                        className={`grid h-14 w-14 place-items-center rounded-xl border-2 border-ink ${f.color}`}
                      >
