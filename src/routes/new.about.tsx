...
import {
  BrandMark, ChunkyButton, DotsBg, Frame, FloatingTickets, Stamp, Ticket, TOKENS,
...
const TENETS = [
  ...
  { ico: "🤖", h: "AI does the boring part",   b: "we pick. you go. no spreadsheets, no group chats." },
  ...
  return (
    <Frame>
      <div style={{
        ...
        <Stamp color={TOKENS.accent1} rotate={-3} style={{ alignSelf: "flex-start" }}>about confetti</Stamp>
        <h1 style={{
        ...
        }}>Confetti<br/>prints<br/>nights.</h1>
        ...
        <div style={{
          ...
          <Ticket color={TOKENS.accent2} notch={false} style={{ padding: 14, marginBottom: 14 }}>
            <div style={{
              fontFamily: TOKENS.ui, fontSize: 14, fontWeight: 700, lineHeight: 1.4,
            }}>We're a small team in Brooklyn building the night-out app we always wanted: print a great night in one tap, walk out the door, remember it forever.</div>
          </Ticket>
          ...
          {TENETS.map((t) => (
            <div key={t.h} style={{
              ...
              <div style={{
                ...
                background: TOKENS.accent2, border: `2.5px solid ${TOKENS.ink}`,
              ...
              <div>
                ...
                <div style={{
                  ...
                  opacity: 0.65, marginTop: 4, lineHeight: 1.4,
                }}>{t.b}</div>
              </div>
            </div>
          ))}
        ...
        <ChunkyButton variant="accent" onClick={() => navigate({ to: "/new/hub" })}>back to printing</ChunkyButton>
      </div>
    </Frame>
  );
}
