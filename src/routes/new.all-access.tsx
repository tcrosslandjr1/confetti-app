    ...
    <Frame>
      <div style={{
        ...
        <div style={{
          ...
          <Stamp color={TOKENS.accent2} rotate={-4} style={{ alignSelf: "flex-start", marginBottom: 12 }}>
            7-day free trial
          </Stamp>
          <h1 style={{
            fontFamily: TOKENS.display, fontWeight: 900,
            fontSize: 42, lineHeight: 0.92, letterSpacing: "-0.04em",
            margin: "0 0 8px",
          }}>All-Access.<br/>Every <span style={{ color: TOKENS.accent1 }}>everything</span>.</h1>
          <p style={{
            fontFamily: TOKENS.ui, fontSize: 14, fontWeight: 600,
            opacity: 0.65, margin: "0 0 18px",
          }}>Unlock the full Confetti toolkit. Cancel any time in Settings.</p>

          {/* Pricing pill toggle */}
          <div style={{ display: "flex", gap: 8, marginBottom: 18 }}>
            <button onClick={() => setPlan("monthly")} style={pricingBtn(plan === "monthly")}>
              <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: ".12em", opacity: 0.7 }}>MONTHLY</div>
            ...
            <button onClick={() => setPlan("yearly")} style={pricingBtn(plan === "yearly")}>
              <div style={{
                ...
                fontFamily: TOKENS.mono, fontSize: 8, fontWeight: 800, letterSpacing: ".14em",
              }}>SAVE 17%</div>
              <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: ".12em", opacity: 0.7 }}>YEARLY</div>
          ...
          <div style={{
            ...
            {FEATURES.map((f) => (
              <div key={f.label} style={{
                ...
                background: TOKENS.paper, padding: "10px 12px",
                boxShadow: `3px 3px 0 ${TOKENS.ink}`,
              }}>
                ...
                <div style={{
                  ...
                  opacity: 0.55, marginTop: 2, letterSpacing: ".04em",
                }}>{f.sub}</div>
              </div>
            ))}
          </div>
