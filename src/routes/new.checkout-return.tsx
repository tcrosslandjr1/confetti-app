...
function CheckoutReturnPage() {
  ...
  const trialing =
    session?.subscription?.trialEnd && session.subscription.trialEnd * 1000 > Date.now();
      ...
      >
        ...
        >
          {loading ? (
            <>
              ...
              >
                One sec — talking to Stripe.
              </p>
            </>
          ) : error ? (
            <>
              <div style={{ alignSelf: "flex-start", marginBottom: 8 }}>
                <Stamp color={TOKENS.accent1} rotate={-2}>
                  error
                </Stamp>
              </div>
              <h1
            ...
            <>
              ...
              <Ticket color={TOKENS.accent1} notch style={{ padding: 14 }}>
                <div style={{ color: TOKENS.paper }}>
                  ...
                  >
                    RECEIPT · {session_id.slice(0, 12).toUpperCase()}
                  </div>
                  <div
                    style={{
                      fontFamily: TOKENS.display,
              ...
              >
                Your All-Access pass is active. Go explore!
              </p>
            </>
          ) : (
            <>
        ...
        >
          {error ? (
            <ChunkyButton
              variant="accent"
              onClick={() => navigate({ to: "/new/paywall" })}
              icon={Icons.arrow}
            >
              try again
            </ChunkyButton>
