      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={() => navigate({ to: "/new/night" })} style={{
            ...
            color: TOKENS.paper,
            fontFamily: TOKENS.mono, fontSize: 11, fontWeight: 800, letterSpacing: ".1em",
            backdropFilter: "blur(8px)",
          }}>← close</button>
          <span style={{
            padding: "5px 10px", borderRadius: 999,
            border: `2px solid ${TOKENS.accent1}`, background: "rgba(0,0,0,0.5)",
            fontFamily: TOKENS.mono, fontSize: 10, fontWeight: 800,
            letterSpacing: ".14em", color: TOKENS.paper,
          }}>● CAM</span>
          <span style={{ width: 80 }} />
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontFamily: TOKENS.display, fontWeight: 900, fontSize: 80,
            opacity: 0.15,
          }}>📷</div>
        ...
        {/* Filter rail */}
        <div style={{
          position: "absolute", left: 16, right: 16, bottom: 100, zIndex: 3,
          ...
          {FILTERS.map((f) => (
            <button key={f} onClick={() => setFilter(f)} style={{
              ...
              fontFamily: TOKENS.mono, fontSize: 10, fontWeight: 800,
              letterSpacing: ".1em", backdropFilter: "blur(6px)",
            }}>{f}</button>
          ))}
        </div>
        ...
        {/* Shutter */}
        <div style={{
          position: "absolute", left: 0, right: 0, bottom: 24, zIndex: 3,
          display: "grid", placeItems: "center",
        }}>
          <button onClick={() => navigate({ to: "/new/finished" })} aria-label="shoot" style={{
            appearance: "none", cursor: "pointer",
