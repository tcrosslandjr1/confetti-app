  ...
  return (
    <Frame>
      <div style={{
        ...
        <Stamp color={TOKENS.accent2} rotate={-3} style={{ alignSelf: "flex-start" }}>your crews</Stamp>
        <h1 style={{
        ...
        <div style={{
            ...
            <Ticket key={i} color={TOKENS.paper} notch style={{ padding: 14, marginBottom: 12 }}>
              ...
              <div style={{ display: "flex", marginTop: 10 }}>
                {c.members.map((m, j) => (
                  <div key={m.who} style={{
                    ...
                    background: m.c, border: `2.5px solid ${TOKENS.ink}`,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  letterSpacing: ".12em", color: TOKENS.accent1,
                }}>NEXT · {c.next.toUpperCase()}</div>
                <button onClick={() => navigate({ to: "/new/night-together" })} style={{
          ...
          <div style={{
            ...
            letterSpacing: "-0.01em", opacity: 0.55, cursor: "pointer",
          }}>+ start a new crew</div>
        </div>

        <div style={{ marginTop: 12 }}>
          <ChunkyButton variant="accent" onClick={() => navigate({ to: "/new/night-together" })}
            icon={Icons.arrow}>plan tonight together</ChunkyButton>
        </div>
      </div>
    </Frame>
  );
