      ...
      >
        ...
        >
          ...
          <div style={{ alignSelf: "center", marginBottom: 10 }}>
            <Stamp color={TOKENS.accent2} rotate={-2}>
              verify · email
            </Stamp>
          </div>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: sessionError ? 8 : 0 }}>
          <ChunkyButton variant="ghost" onClick={() => navigate({ to: "/new/email-verify" })}>
            resend
          </ChunkyButton>
          <ChunkyButton
            variant="accent"
            ...
            icon={Icons.arrow}
          >
            {checking ? "checking..." : "i clicked it"}
          </ChunkyButton>
        </div>
      </div>
    </Frame>
