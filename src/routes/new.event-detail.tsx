  ...
  return (
    <Frame>
      <div style={{
        ...
        <div style={{
          position: "relative",
          height: 240, background: TOKENS.accent3,
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <button onClick={() => navigate({ to: "/new/events" })} style={{
              appearance: "none", cursor: "pointer",
              width: 36, height: 36, borderRadius: 999,
              border: `2.5px solid ${TOKENS.ink}`, background: TOKENS.paper,
              color: TOKENS.ink, fontSize: 14, fontWeight: 900, boxShadow: `3px 3px 0 ${TOKENS.ink}`,
            }}>←</button>
            <div style={{ color: TOKENS.paper }}><BrandMark size={17} /></div>
            <span style={{ width: 36 }} />
          </div>
          <div>
            <Stamp color={TOKENS.accent2} rotate={-3} style={{ alignSelf: "flex-start" }}>fri may 30 · disco</Stamp>
            <h1 style={{
              fontFamily: TOKENS.display, fontWeight: 900,
              fontSize: 40, lineHeight: 0.92, letterSpacing: "-0.04em",
              margin: "10px 0 0", color: TOKENS.paper,
        ...
        <div style={{
          ...
          }}>📍 89 BOGART · BUSHWICK · 8 PM – 4 AM</div>
          ...
          <Ticket color={TOKENS.accent1} notch={false} style={{ padding: 14, marginTop: 14 }}>
            <div style={{
              ...
              <div style={{
                fontFamily: TOKENS.display, fontWeight: 900, fontSize: 24,
                letterSpacing: "-0.02em",
              }}>$22</div>
            </div>
            <div style={{
              fontFamily: TOKENS.ui, fontSize: 12, fontWeight: 700, marginTop: 4, opacity: 0.85,
            }}>$32 at door · 200 left</div>
          </Ticket>
          ...
          {LINEUP.map((dj) => (
            <div key={dj.name} style={{
              ...
              <div style={{
                fontFamily: TOKENS.mono, fontSize: 11, fontWeight: 800,
                letterSpacing: ".06em", opacity: 0.6,
              }}>{dj.set}</div>
            </div>
          ))}
          ...
          <Ticket color={TOKENS.accent2} notch={false} style={{ padding: 14, marginTop: 18 }}>
            ...
            }}>You rated 3 disco nights ★★★★★ this year. Honey Dijon's set is the closer — you'll want to be there.</div>
          </Ticket>

          <div style={{ height: 14 }} />
        </div>

        <div style={{ position: "relative", zIndex: 2, padding: "0 20px", display: "flex", gap: 8 }}>
          <ChunkyButton variant="ghost" onClick={() => navigate({ to: "/new/events" })}>save</ChunkyButton>
          <ChunkyButton variant="accent" onClick={() => navigate({ to: "/new/pass" })} icon={Icons.arrow}>
            grab ticket
          </ChunkyButton>
        </div>
      </div>
