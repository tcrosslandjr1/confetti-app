...
const EVENTS = [
  { date: "FRI MAY 30", time: "8:00 PM", title: "Loft Disco · Brooklyn Warehouse", tag: "music", color: TOKENS.accent3, fg: TOKENS.paper, price: "$22" },
  { date: "SAT MAY 31", time: "11:00 AM", title: "Morning Market · McCarren Park", tag: "outdoor", color: TOKENS.accent2, price: "free" },
  { date: "SAT MAY 31", time: "9:00 PM", title: "Roof Cinema · Sunset Park", tag: "film", color: TOKENS.accent1, price: "$15" },
  { date: "SUN JUN 01", time: "7:30 PM", title: "Comedy Basement · LES", tag: "comedy", color: TOKENS.paper, price: "$18" },
  { date: "TUE JUN 03", time: "8:00 PM", title: "Jazz Night · Joe's Tavern", tag: "live", color: TOKENS.accent2, price: "no cover" },
];
    ...
    <Frame>
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          <Stamp color={TOKENS.accent2} rotate={-3} style={{ alignSelf: "flex-start", marginBottom: 10 }}>this week</Stamp>
          <h2 style={{
            fontFamily: TOKENS.display, fontWeight: 900,
            fontSize: 36, lineHeight: 0.95, letterSpacing: "-0.04em",
            margin: "0 0 12px",
          }}>What's<br/>happening.</h2>
        </div>
        ...
        <div style={{
          ...
          {EVENTS.map((e, i) => (
            <button key={i} onClick={() => navigate({ to: "/new/event-detail" })} style={{
              ...
              <div style={{
                ...
                background: e.color, color: e.fg ?? TOKENS.ink,
                display: "grid", placeItems: "center",
                fontFamily: TOKENS.display, fontWeight: 900, fontSize: 10,
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                }}>{e.time} · {e.tag.toUpperCase()}</div>
                <div style={{
                  fontFamily: TOKENS.display, fontWeight: 900, fontSize: 15,
                  letterSpacing: "-0.02em", marginTop: 2, lineHeight: 1.15,
                }}>{e.title}</div>
                <div style={{
