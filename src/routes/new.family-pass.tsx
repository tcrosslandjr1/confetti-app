    ...
    <Frame>
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={() => navigate({ to: "/new/family-plan" })} style={backBtn()}>←</button>
          <BrandMark size={17} />
          <span style={{ width: 36 }} />
        </div>

        <Stamp color={TOKENS.accent2} rotate={-3} style={{ alignSelf: "flex-start" }}>family pass</Stamp>
        <h1 style={{
          fontFamily: TOKENS.display, fontWeight: 900,
          fontSize: 36, lineHeight: 0.92, letterSpacing: "-0.04em",
          margin: "10px 0 14px",
        }}>Saturday,<br/>printed.</h1>
        ...
        <div style={{
          ...
          <div style={{
            ...
            letterSpacing: ".16em", opacity: 0.55, marginTop: 14, marginBottom: 8,
          }}>PACK LIST</div>
          <div style={{
            padding: 12, border: `2.5px solid ${TOKENS.ink}`, borderRadius: 14,
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
          <ChunkyButton variant="ghost" onClick={() => navigate({ to: "/new/trips" })}>save</ChunkyButton>
