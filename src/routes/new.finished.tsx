      ...
      >
        ...
        >
          ...
          >
            That was
            <br />
            <span style={{ color: TOKENS.accent1 }}>a night.</span>
          </h1>
          ...
          <Ticket color={TOKENS.paper} notch={false} style={{ padding: 16 }}>
            ...
            >
              <span>{loop?.date?.toUpperCase() ?? "TONIGHT"}</span>
              <span>{passCode}</span>
            </div>
            {stops.map((s, i) => (
              <div
            ...
            >
              <span>TOTAL</span>
              <span>{loop?.estimatedSpend ?? "—"}</span>
            </div>
            <div style={{ display: "flex", gap: 8, marginTop: 12, flexWrap: "wrap" }}>
              <Stamp color={TOKENS.accent2} rotate={-3} style={{ fontSize: 10 }}>
                foodie
              </Stamp>
              <Stamp color={TOKENS.accent1} rotate={2} style={{ fontSize: 10 }}>
                chill
              </Stamp>
              <Stamp
                color={TOKENS.accent3}
                rotate={-2}
                style={{ fontSize: 10, color: TOKENS.paper }}
              >
                walkable
              </Stamp>
            </div>
