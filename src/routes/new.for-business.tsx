  ...
  return (
    <Frame>
      <div style={{
        ...
        <Stamp color={TOKENS.accent2} rotate={-3} style={{ alignSelf: "flex-start" }}>for venues</Stamp>
        <h1 style={{
          fontFamily: TOKENS.display, fontWeight: 900,
          fontSize: 36, lineHeight: 0.92, letterSpacing: "-0.04em",
          margin: "10px 0 14px",
        }}>Fill seats.<br/>Skip the ads.</h1>
            ...
            {STATS.map((s) => (
              <div key={s.l} style={{
                ...
                <div style={{
                  ...
                  letterSpacing: ".12em", opacity: 0.9, marginTop: 2,
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
          <ChunkyButton variant="ghost" onClick={() => navigate({ to: "/new/hub" })}>see demo</ChunkyButton>
          <ChunkyButton variant="accent" onClick={() => navigate({ to: "/new/signup" })}
            icon={Icons.arrow}>list your venue</ChunkyButton>
        </div>
      </div>
    </Frame>
  );
