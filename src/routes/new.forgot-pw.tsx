      ...
      <div style={{
        ...
        {sent ? (
          <div style={{
            ...
            <div style={{
              padding: 20, border: `3px solid ${TOKENS.ink}`, borderRadius: 18,
              background: TOKENS.accent2, boxShadow: `5px 5px 0 ${TOKENS.ink}`,
            }}>
              <div style={{ fontFamily: TOKENS.mono, fontSize: 10, fontWeight: 800, letterSpacing: ".14em", color: TOKENS.inkHint }}>CHECK YOUR INBOX</div>
              <div style={{ fontFamily: TOKENS.display, fontWeight: 900, fontSize: 22, letterSpacing: "-0.025em", marginTop: 6, lineHeight: 1.1 }}>
                Reset link sent to<br/>{email}.
              </div>
              <button onClick={() => navigate({ to: "/new/signin" })} style={{
                appearance: "none", cursor: "pointer", marginTop: 14, padding: "10px 16px",
          ...
          <>
            ...
            {error && (
              <div style={{ padding: "10px 14px", borderRadius: 10, background: "#fee2e2", border: "2px solid #ef4444", fontFamily: TOKENS.ui, fontSize: 13, fontWeight: 600, color: "#991b1b", marginBottom: 10 }}>
                {error}
              </div>
            )}
            ...
            <div style={{
              ...
              letterSpacing: ".14em", color: TOKENS.inkHint, marginBottom: 4,
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <ChunkyButton variant="accent" onClick={handleReset} disabled={loading}
                icon={Icons.arrow}>{loading ? "sending..." : "send link"}</ChunkyButton>
            </div>
          </>
        )}
      </div>
