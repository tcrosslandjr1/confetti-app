  ...
  return (
    <Frame>
      ...
      >
        ...
        >
          <button onClick={() => navigate({ to: "/new/crews" })} style={backBtn()}>
            ←
          </button>
          <BrandMark size={17} />
          <span style={{ width: 36 }} />
        ...
        >
          ...
          <Ticket color={TOKENS.accent3} notch={false} style={{ padding: 14 }}>
            <div style={{ color: TOKENS.paper }}>
              ...
              >
                4-way split on stops · drinks self-pay
              </div>
            </div>
          </Ticket>
        </div>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
          <ChunkyButton variant="ghost" onClick={() => navigate({ to: "/new/crews" })}>
            back
          </ChunkyButton>
          <ChunkyButton
            variant="accent"
            onClick={() => navigate({ to: "/new/printing" })}
            icon={Icons.arrow}
          >
            print our night
          </ChunkyButton>
