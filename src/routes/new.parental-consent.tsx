    ...
    <Frame>
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={() => navigate({ to: "/new/age-gate" })} style={backBtn()}>←</button>
          <BrandMark size={17} />
          <span style={{ width: 36 }} />
        </div>

        <Stamp color={TOKENS.accent3} rotate={-3} style={{ alignSelf: "flex-start" }}>parent / guardian</Stamp>
        <h1 style={{
          fontFamily: TOKENS.display, fontWeight: 900,
          fontSize: 36, lineHeight: 0.92, letterSpacing: "-0.04em",
          margin: "10px 0 6px",
        }}>We need a<br/>grown-up.</h1>
        <p style={{
          fontFamily: TOKENS.ui, fontSize: 13, fontWeight: 700, opacity: 0.6,
          margin: "0 0 18px",
        }}>For under 13, we email your parent to set things up safely.</p>
        ...
        <Ticket color={TOKENS.paper} notch={false} style={{ padding: 12 }}>
          ...
          <ul style={{
            ...
            fontFamily: TOKENS.ui, fontSize: 12, fontWeight: 700, lineHeight: 1.6,
          }}>
        ...
        <ChunkyButton variant="accent" onClick={() => navigate({ to: "/new/email-verify" })}
          icon={Icons.arrow}>email my parent</ChunkyButton>
      </div>
    </Frame>
  );
}
