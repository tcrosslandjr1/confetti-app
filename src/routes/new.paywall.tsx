...
import {
  BrandMark, DotsBg, FloatingTickets, Frame, Stamp, TOKENS,
...
const PAID_FEATURES = [
  ...
  "Boarding passes", "Party Memory Kit", "RSVP tracker", "Confetti rewards",
];
    ...
    <Frame>
      <div style={{
        ...
        <div style={{
          ...
          <Stamp color={TOKENS.accent1} rotate={-3} style={{ alignSelf: "flex-start", marginBottom: 12 }}>
            pick a path
          </Stamp>
          <h1 style={{
          ...
          <button onClick={onPaid} style={{
            ...
            <div style={{
              fontFamily: TOKENS.display, fontWeight: 900, fontSize: 38,
            ...
            <ul style={{
              ...
              {PAID_FEATURES.map((f) => (
                <li key={f} style={{ display: "flex", gap: 5 }}>✓ {f}</li>
              ))}
            </ul>
          </button>
