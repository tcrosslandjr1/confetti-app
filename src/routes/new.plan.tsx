        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          {hasPinned && (
            <div
              style={{
                marginBottom: 22,
                padding: "14px 16px",
                border: `2.5px solid ${TOKENS.accent1}`,
                borderRadius: 14,
          ...
          <div style={{ marginBottom: 22 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {["Now", "Tonight", "Tomorrow", "This weekend"].map((t) => (
                <Chip
                  key={t}
                  selected={state.when === t}
                  color={TOKENS.accent2}
                  onClick={() => setState({ ...state, when: t })}
                >
                  {t}
                </Chip>
              ))}
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 900,
                    boxShadow:
                      state.budget === b.id ? `3px 3px 0 ${TOKENS.ink}` : `0 0 0 ${TOKENS.ink}`,
          ...
          <div style={{ marginBottom: 22 }}>
            ...
            >
              ...
              >
                {state.crew === 1 ? "just me" : `${state.crew} ppl`}
              </span>
            </div>
          </div>
