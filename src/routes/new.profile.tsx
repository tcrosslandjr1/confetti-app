...
function ProfilePage() {
  ...
  const joinYear = user?.created_at
    ...
    : null;
  const cityMeta =
    [user?.user_metadata?.city, joinYear ? `since ${joinYear}` : null]
      .filter(Boolean)
      .join(" · ") || "";
      ...
      <Frame>
        ...
        >
          ...
          >
            ...
            >
              Save your scrapbook, earn stamps,
              <br />
              and keep up with your crew.
            </p>
    ...
    <Frame>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          >
            0 nights printed · {STAMPS.length} stamps · 0 in crew
          </p>
        </div>

        {/* Wallet pass ticket */}
        <div
          onClick={() => navigate({ to: "/new/wallet" })}
          ...
          <Ticket color={TOKENS.accent2} notch style={{ padding: 14 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                ...
                >
                  {confettiPoints.toLocaleString()} confetti
                </div>
              </div>
              <div
                style={{
          ...
          {tab === "crew" && (
            <>
              ...
              <div style={{ marginTop: 8 }}>
                <ChunkyButton variant="ghost" onClick={() => navigate({ to: "/new/crew-map" })}>
                  see crew map
                </ChunkyButton>
              </div>
            </>
