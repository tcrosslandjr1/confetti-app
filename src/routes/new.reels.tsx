...
const REELS = [
  { who: "Sara", at: "Lupa Notte", color: TOKENS.accent1, caption: "the pasta. the lighting. unreal." },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={(e) => { e.stopPropagation(); navigate({ to: "/new/hub" }); }} style={{
            appearance: "none", cursor: "pointer",
            padding: "6px 12px", borderRadius: 999,
            border: `2px solid ${TOKENS.paper}`, background: "rgba(0,0,0,0.4)",
            color: TOKENS.paper,
            fontFamily: TOKENS.mono, fontSize: 11, fontWeight: 800, letterSpacing: ".12em",
          ...
          <div style={{
            ...
            {REELS.map((_, j) => (
              <span key={j} style={{
                width: j === i ? 22 : 4, height: 4, borderRadius: 999,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              width: 8, height: 8, borderRadius: 999, background: TOKENS.accent1,
        ...
        <div style={{
          ...
          color: TOKENS.paper, opacity: 0.55, letterSpacing: ".18em",
