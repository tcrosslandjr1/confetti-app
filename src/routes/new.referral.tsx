  ...
  return (
    <Frame>
      <div style={{
        ...
        padding: "60px 24px 28px", overflow: "hidden",
      }}>
        <DotsBg opacity={0.06} />
        ...
        <div style={{
          ...
          display: "flex", flexDirection: "column",
          justifyContent: "center", gap: 16, paddingTop: 14,
        }}>
          <Stamp color={TOKENS.accent2} rotate={-3} style={{ alignSelf: "flex-start" }}>your invite</Stamp>
          ...
          <Ticket color={TOKENS.paper} notch={false} style={{ padding: 18 }}>
            <div style={{
              ...
              <div style={{
                ...
                background: TOKENS.accent1, border: `2.5px solid ${TOKENS.ink}`,
              ...
              <div>
                ...
                }}>Jess from Brooklyn</div>
              </div>
            </div>
            <p style={{
              fontFamily: TOKENS.ui, fontSize: 13, fontWeight: 700,
              margin: 0, opacity: 0.75, lineHeight: 1.4,
            }}>
          ...
          <h1 style={{
            ...
            margin: 0,
          }}>Your first<br/>pass is <span style={{ color: TOKENS.accent1 }}>on us.</span></h1>

          <p style={{
            fontFamily: TOKENS.ui, fontSize: 14, fontWeight: 600,
            opacity: 0.7, margin: 0, lineHeight: 1.45, maxWidth: 320,
          }}>
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 4 }}>
            {[
              ...
              <span key={c.label} style={{
                ...
                background: c.color, color: c.fg ?? TOKENS.ink,
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          <ChunkyButton variant="accent" onClick={() => navigate({ to: "/new/signup" })} icon={Icons.arrow}>
            Claim my invite
          </ChunkyButton>
          <div style={{
