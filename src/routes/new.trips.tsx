  ...
  return (
    <Frame>
      <div style={{
        ...
        <Stamp color={TOKENS.accent2} rotate={-3} style={{ alignSelf: "flex-start" }}>your passes</Stamp>
        <h1 style={{
            ...
            <button key={i}
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  background: t.status === "live" ? TOKENS.accent1
                            : t.status === "upcoming" ? TOKENS.accent2 : TOKENS.bg,
                  fontFamily: TOKENS.mono, fontSize: 9, fontWeight: 800,
                ...
                {t.stops.map((s, j) => (
                  <div key={j} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    <span style={{
                      ...
                      background: t.color, border: `1.5px solid ${TOKENS.ink}`,
                    }} />
                    <span style={{
                    ...
                    {j < t.stops.length - 1 && (
                      <span style={{
                        width: 10, height: 0, borderTop: `1.5px dashed ${TOKENS.ink}`,
                      }} />
                    )}
                  </div>
                ))}
