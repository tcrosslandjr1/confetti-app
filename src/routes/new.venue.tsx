  ...
  return (
    <Frame>
      <div style={{
        ...
        <div style={{
          position: "relative",
          height: 220, background: TOKENS.accent1,
          ...
          <Stamp color={TOKENS.paper} rotate={-3} style={{ alignSelf: "flex-start" }}>italian · wine bar</Stamp>
        </div>
        ...
        <div style={{
          ...
          <Ticket color={TOKENS.accent2} notch={false} style={{ padding: 14, marginTop: 18 }}>
            ...
            }}>WHY WE'D SEND YOU HERE</div>
            <div style={{
              fontFamily: TOKENS.display, fontWeight: 900, fontSize: 17,
              letterSpacing: "-0.02em", marginTop: 6, lineHeight: 1.15,
            }}>You love foodie + walkable. This is the heart of Williamsburg, 2 mins from your last 3 cocktail stops.</div>
          </Ticket>
          ...
          }}>WHAT REAL PEOPLE SAID</div>
          {REVIEWS.map((r) => (
            <div key={r.who} style={{
              border: `2px solid ${TOKENS.ink}`, borderRadius: 12,
              background: TOKENS.paper, padding: 12, marginBottom: 8,
            }}>
              <div style={{
                fontFamily: TOKENS.ui, fontSize: 13, fontWeight: 700, lineHeight: 1.4,
              }}>"{r.body}"</div>
              <div style={{
                fontFamily: TOKENS.mono, fontSize: 9, fontWeight: 800,
                letterSpacing: ".14em", opacity: 0.55, marginTop: 6,
              }}>— {r.who.toUpperCase()}</div>
            </div>
          ))}
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "0 20px", display: "flex", gap: 8 }}>
          <ChunkyButton variant="ghost" onClick={() => navigate({ to: "/new/explore" })}>save</ChunkyButton>
