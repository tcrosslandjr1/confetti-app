  ...
  return (
    <div className="min-h-screen bg-background pb-32">
      <div className="mx-auto max-w-md px-4 pt-6">
        <Link
          to="/"
          className="inline-flex items-center gap-1 font-mono text-xs font-bold uppercase tracking-widest text-cream/70 hover:text-cream"
        >
        ...
        <div className="mt-8 text-center">
          <p className="font-serif italic text-cream/70">Plan your own unforgettable night.</p>
          <Link
            to="/"
