    ...
    <div className="min-h-screen bg-background pb-32">
      <div className="mx-auto max-w-5xl px-4 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col items-start gap-3 rounded-2xl border-2 border-dashed border-ink/30 bg-cream/60 p-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            to="/passport"
            className="inline-flex items-center gap-1.5 rounded-full border-2 border-ink bg-coral px-4 py-2 font-mono text-[11px] font-bold uppercase tracking-widest text-cream shadow-brut hover:-translate-y-0.5 transition-transform"
          >
...
function PartnerCard({ partner, featured }: { partner: Partner; featured?: boolean }) {
  ...
  return (
    <article
      className={`group relative overflow-hidden rounded-2xl border-2 border-ink bg-card shadow-brut transition-transform hover:-translate-y-0.5 ${
        featured ? "" : ""
      }`}
    >
      {/* Cover */}
      <div className={`relative h-28 bg-gradient-to-br ${partner.gradient}`}>
        ...
        />
        {featured && (
          <span className="absolute right-3 top-3 inline-flex items-center gap-1 rounded-full border-2 border-ink bg-cream px-2 py-0.5 font-mono text-[9px] font-bold uppercase tracking-widest text-ink">
      ...
      <div className="p-4">
        ...
        <div className="mt-3 flex items-center justify-between gap-2 rounded-xl border border-dashed border-ink/30 bg-background px-3 py-2">
          ...
          <Link
            to="/passport"
            className="inline-flex shrink-0 items-center gap-1 rounded-full border-2 border-ink bg-background px-2.5 py-1 font-mono text-[10px] font-bold uppercase tracking-widest text-ink hover:bg-ink hover:text-cream"
          >
