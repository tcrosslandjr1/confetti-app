...
const MOCK_DC_VIRAL: Row[] = [
  {
    ...
    address: "1346 4th St SE, Washington, DC",
    photo_url: null,
    rating: 4.8,
    trend_score: 2.94,
    ...
    source_urls: [
      { url: "https://www.eater.com/", query: "Albi DC", authority: 95 },
      { url: "https://www.washingtonian.com/", query: "Albi best restaurants", authority: 90 },
    ],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 6).toISOString(),
    mention_count: 312,
  },
  {
    id: "mock-v-2",
    ...
    address: "920 Blagden Alley NW, Washington, DC",
    photo_url: null,
    rating: 4.7,
    trend_score: 2.71,
    ...
    google_place_id: null,
    source_urls: [
      { url: "https://www.washingtonpost.com/", query: "Causa DC review", authority: 95 },
    ],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 18).toISOString(),
    mention_count: 264,
  },
  {
    id: "mock-v-3",
    ...
    google_place_id: null,
    source_urls: [
      { url: "https://www.tiktok.com/", query: "Rose's Luxury DC", authority: 70 },
    ],
  ...
  },
  {
    ...
    google_place_id: null,
    source_urls: [
      { url: "https://www.theinfatuation.com/", query: "Maydan", authority: 85 },
    ],
  ...
  },
  {
    ...
    google_place_id: null,
    source_urls: [
      { url: "https://www.washingtonian.com/", query: "Le Diplomate brunch", authority: 90 },
    ],
  ...
  },
  {
    ...
    address: "801 Wharf St SW, Washington, DC",
    photo_url: null,
    rating: 4.6,
    trend_score: 2.02,
    ...
    google_place_id: null,
    source_urls: [
      { url: "https://www.tiktok.com/", query: "Moon Rabbit DC", authority: 70 },
    ],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 9).toISOString(),
    mention_count: 176,
  },
  {
    id: "mock-v-7",
    ...
    google_place_id: null,
    source_urls: [
      { url: "https://www.instagram.com/", query: "Hi-Lawn DC", authority: 65 },
    ],
  ...
  },
  {
    ...
    address: "732 Maryland Ave NE, Washington, DC",
    photo_url: null,
    rating: 4.7,
    trend_score: 1.74,
    ...
    google_place_id: null,
    source_urls: [
      { url: "https://www.eater.com/", query: "Pascual DC opening", authority: 95 },
    ],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(),
    mention_count: 152,
  },
];
