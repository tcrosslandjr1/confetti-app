...
const MOCK_DC_VIRAL: Row[] = [
  {
    ...
    rating: 4.8,
    trend_score: 9.8,
    tags: ["date_night", "foodie_hype"] as ViralTag[],
    summary: "Wood-fire dining with communal platters · #DateNight #Firepit",
    google_place_id: null,
    source_urls: [{ url: "https://www.eater.com/", query: "Maydan DC", authority: 95 }],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 4).toISOString(),
    mention_count: 142,
  },
  {
    id: "mock-v-2",
    city: "Washington DC",
    venue_name: "Bad Saint",
    neighborhood: "Columbia Heights",
    address: "3226 11th St NW, Washington, DC",
    photo_url: null,
    rating: 4.9,
    trend_score: 9.5,
    tags: ["hidden_gem", "worth_the_wait"] as ViralTag[],
    summary: "No-reservations Filipino street food · #StreetFood #NoRez",
    google_place_id: null,
    source_urls: [{ url: "https://www.washingtonian.com/", query: "Bad Saint", authority: 90 }],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 8).toISOString(),
    mention_count: 128,
  },
  {
    id: "mock-v-3",
    ...
    rating: 4.6,
    trend_score: 9.2,
    tags: ["instagrammable", "photo_op"] as ViralTag[],
    summary: "Parisian brasserie energy all day · #Brunch #SeeAndBeSeen",
    google_place_id: null,
    source_urls: [{ url: "https://www.washingtonian.com/", query: "Le Diplomate", authority: 90 }],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 12).toISOString(),
    mention_count: 115,
  },
  {
    id: "mock-v-4",
    city: "Washington DC",
    venue_name: "Tail Up Goat",
    neighborhood: "Adams Morgan",
    address: "1827 Adams Mill Rd NW, Washington, DC",
    photo_url: null,
    rating: 4.7,
    trend_score: 9.0,
    tags: ["hidden_gem", "date_night"] as ViralTag[],
    summary: "Wood-fired dishes & natural wines · #NaturalWine #Cozy",
    google_place_id: null,
    source_urls: [{ url: "https://www.theinfatuation.com/", query: "Tail Up Goat", authority: 85 }],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 16).toISOString(),
    mention_count: 98,
  },
  {
    id: "mock-v-5",
    ...
    rating: 4.7,
    trend_score: 8.8,
    tags: ["creator_mentioned", "foodie_hype"] as ViralTag[],
    summary: "Modern Indian with crispy spinach · #FineDining #Spice",
    google_place_id: null,
    source_urls: [{ url: "https://www.washingtonpost.com/", query: "Rasika", authority: 95 }],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 20).toISOString(),
    mention_count: 91,
  },
  {
    id: "mock-v-6",
    city: "Washington DC",
    venue_name: "Oyster Oyster",
    neighborhood: "Shaw",
    address: "1440 8th St NW, Washington, DC",
    photo_url: null,
    rating: 4.8,
    trend_score: 8.6,
    tags: ["creator_mentioned", "trending_this_week"] as ViralTag[],
    summary: "Innovative plant-based tasting menus · #PlantBased #Tasting",
    google_place_id: null,
    source_urls: [{ url: "https://www.eater.com/", query: "Oyster Oyster", authority: 95 }],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(),
    mention_count: 87,
  },
  {
    id: "mock-v-7",
    ...
    venue_name: "Cranes",
    neighborhood: "Penn Quarter",
    address: "724 9th St NW, Washington, DC",
    photo_url: null,
    rating: 4.6,
    trend_score: 8.4,
    tags: ["foodie_hype", "creator_mentioned"] as ViralTag[],
    summary: "Omakase meets tapas · #Omakase #Fusion",
    google_place_id: null,
    source_urls: [{ url: "https://www.theinfatuation.com/", query: "Cranes DC", authority: 85 }],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 30).toISOString(),
    mention_count: 76,
  },
  {
    id: "mock-v-8",
    city: "Washington DC",
    venue_name: "Fiola Mare",
    neighborhood: "Georgetown",
    address: "3050 K St NW, Washington, DC",
    photo_url: null,
    rating: 4.6,
    trend_score: 8.2,
    tags: ["photo_op", "date_night"] as ViralTag[],
    summary: "Italian seafood on the Georgetown waterfront · #Waterfront #Seafood",
    google_place_id: null,
    source_urls: [{ url: "https://www.washingtonian.com/", query: "Fiola Mare", authority: 90 }],
    last_mentioned_at: new Date(Date.now() - 1000 * 60 * 60 * 36).toISOString(),
    mention_count: 72,
  },
];
