  ...
  head: () => ({
    meta: [
      { title: "AI Translator — translate text between 30+ languages" },
      {
        name: "description",
        content:
          "Free AI-powered translator. Translate text between 30+ languages with natural, formal, casual, or literal tones.",
      },
    ],
  }),
...
function TranslatePage() {
  ...
  const canSubmit = useMemo(
    () => input.trim().length > 0 && target.length > 0 && !mut.isPending,
    [input, target, mut.isPending],
  );
