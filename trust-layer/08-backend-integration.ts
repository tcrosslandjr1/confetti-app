...
//
// This file re-exports the core services from 06-hooks-and-services
// AND adds the integration glue: the adapter that extends the
// existing VenueCard type with trust signals, and a provider
// component that fetches everything in one shot.
// ============================================================
...
// When copying to src/services/trust/, rename 01-types.ts → types.ts
// and 08-backend-integration.ts → backend-integration.ts
import type {
  VenueVerification,
  VerificationTier,
  CrowdReading,
...
//    (mirrors 06-hooks-and-services but with isSupabaseConfigured guard)
// ============================================================
